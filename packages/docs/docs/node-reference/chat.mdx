...
If you are looking for other language models, see the Plugins page for a list of available plugins that implement other language model nodes.

:::info

The Chat node may be renamed and/or deprecated and moved into an OpenAI plugin in the future.
...
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------- | ---------------- | --------------- |
| Model                           | The GPT model to use for the request.                                                                                                                                                                                                                                                                   | `gpt-3.5-turbo` | Yes              | `string`        |
