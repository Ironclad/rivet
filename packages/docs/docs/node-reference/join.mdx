...
Flattening in the Join Node works similarly to the [Array Node](./array.md). For more information on how flattening works, refer to the documentation for the Array Node.
