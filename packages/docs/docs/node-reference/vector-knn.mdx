...
This node is useful when working with vector databases such as Pinecone, Qdrant where you might want to find the vectors in the database that are most similar to a given input vector.
