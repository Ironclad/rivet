...
## Example 2: Convert an array to JSON

1. Create an [Array Node](./array.mdx) and set the value to the following:

   ```json
   ["apple", "banana", "cherry"]
   ```

2. Create a To JSON Node and connect the Array Node to it.
3. Run the graph. The To JSON Node should output the JSON string representation of the array.
