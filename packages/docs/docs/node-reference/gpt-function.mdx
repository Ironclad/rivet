...
The GPT Function Node does not have any inputs.
...
| ----------- | ------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------- | --------------- |
| Name        | The name of the function. This is the name that GPT will use to call the function in its responses.                 | `newFunction` | No               | `string`        |
| Description | A description of the function. This is used for documentation purposes and does not affect the function's behavior. | (empty)       | No               | `string`        |
| Schema      | The JSON Schema that defines the function's parameters.                                                             | (empty)       | No               | `string`        |
