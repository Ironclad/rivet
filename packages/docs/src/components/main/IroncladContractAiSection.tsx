...
export const IroncladContractAiSection: React.FC<{ id?: string }> = ({ id }) => {
  ...
  return (
    <Section id={id}>
      ...
      <p>
        You can <a href="https://ironcladapp.com/product/ironclad-contract-ai/">learn more about CAI here</a>.
      </p>
      <div className="wistia_responsive_padding" style={{ padding: '56.25% 0 0 0', position: 'relative' }}>
        <div className="wistia_responsive_wrapper" style={{ height: '100%', left: '0', position: 'absolute', top: '0', width: '100%' }}>
          <div className="wistia_embed wistia_async_j74id7k4zx seo=true videoFoam=true" style={{height: '100%', position: 'relative', width: '100%'}}>
            <div useRef={wistiaSwatch} className="wistia_swatch" style={{height: '100%', left: '0', opacity: '0', overflow: 'hidden', position: 'absolute', top: '0', transition: 'opacity 200ms', width: '100%'}}>
              <img src="https://fast.wistia.com/embed/medias/j74id7k4zx/swatch" style={{filter: 'blur(5px)', height: '100%', objectFit: 'contain', width: '100%'}} alt="" aria-hidden="true" onload={() => { wistiaSwatch.style.opacity = 1; }} />
            </div>
          </div>
        </div>
      </div>
